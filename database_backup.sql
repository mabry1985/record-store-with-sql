...
COPY public.albums (name, cost, id, album_year) FROM stdin;
\.
...
COPY public.artists (name, song_id, album_id, id) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.albums_artists_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.albums_id_seq', 1024, true);
...
SELECT pg_catalog.setval('public.artists_id_seq', 167, true);
...
SELECT pg_catalog.setval('public.songs_id_seq', 462, true);
